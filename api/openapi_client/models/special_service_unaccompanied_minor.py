...
class SpecialServiceUnaccompaniedMinor(SpecialService):
    """
    SpecialServiceUnaccompaniedMinor
    """
    unaccompanied_minor_ind: Optional[StrictBool] = Field(None, alias="unaccompaniedMinorInd", description="Indicates that the Traveler is an Unaccompanied minor")
    __properties = ["@type", "id", "Identifier", "AppliesTo", "Status", "ServiceAnimalType", "TravelerIdentifier", "unaccompaniedMinorInd"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SpecialServiceUnaccompaniedMinor:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SpecialServiceUnaccompaniedMinor:
        """Create an instance of SpecialServiceUnaccompaniedMinor from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SpecialServiceUnaccompaniedMinor.parse_obj(obj)

        _obj = SpecialServiceUnaccompaniedMinor.parse_obj({
            "type": obj.get("@type"),
            "id": obj.get("id"),
            ...
            "unaccompanied_minor_ind": obj.get("unaccompaniedMinorInd")
        })
        return _obj
