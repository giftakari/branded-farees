...
class PrimaryContactListRequest(BaseModel):
    """
    PrimaryContactListRequest
    """
    primary_contact: conlist(PrimaryContact, max_items=9, min_items=1) = Field(..., alias="PrimaryContact")
    __properties = ["PrimaryContact"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PrimaryContactListRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PrimaryContactListRequest:
        """Create an instance of PrimaryContactListRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PrimaryContactListRequest.parse_obj(obj)

        _obj = PrimaryContactListRequest.parse_obj({
