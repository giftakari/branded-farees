...
class SpecialServiceResponse(BaseModel):
    ...
    special_service: Optional[SpecialServiceID] = Field(None, alias="SpecialService")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SpecialServiceResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SpecialServiceResponse:
        """Create an instance of SpecialServiceResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SpecialServiceResponse.parse_obj(obj)

        _obj = SpecialServiceResponse.parse_obj({
