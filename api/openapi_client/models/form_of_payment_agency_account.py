...
class FormOfPaymentAgencyAccount(FormOfPaymentID):
    """
    FormOfPaymentAgencyAccount
    """
    agency_id: Optional[constr(strict=True, max_length=32)] = Field(None, alias="agencyId", description="The agency Id")
    __properties = ["@type", "id", "FormOfPaymentRef", "Identifier", "agencyId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FormOfPaymentAgencyAccount:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FormOfPaymentAgencyAccount:
        """Create an instance of FormOfPaymentAgencyAccount from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FormOfPaymentAgencyAccount.parse_obj(obj)

        _obj = FormOfPaymentAgencyAccount.parse_obj({
            "type": obj.get("@type"),
            "id": obj.get("id"),
