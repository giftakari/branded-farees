...
class ProductIdentifier(BaseModel):
    ...
    __properties = ["id", "productRef", "Identifier"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProductIdentifier:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProductIdentifier:
        """Create an instance of ProductIdentifier from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProductIdentifier.parse_obj(obj)

        _obj = ProductIdentifier.parse_obj({
            "id": obj.get("id"),
