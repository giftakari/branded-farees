...
class BrandID(BaseModel):
    ...
    brand_ref: Optional[StrictStr] = Field(None, alias="BrandRef", description="Used to reference another instance of this object in the same message")
    identifier: Optional[Identifier] = Field(None, alias="Identifier")
    __properties = ["@type", "id", "BrandRef", "Identifier"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Union(Brand, BrandCompleteInfo):
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Union(Brand, BrandCompleteInfo):
        ...
        if object_type:
            ...
            raise ValueError("BrandID failed to lookup discriminator value from " +
