...
class LastReservation(BaseModel):
    """
    LastReservation
    """
    ...
    __discriminator_value_class_map = {
        'LastReservationDayOfWeek': 'LastReservationDayOfWeek',
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Union(LastReservationDayOfWeek, LastReservationDuration):
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Union(LastReservationDayOfWeek, LastReservationDuration):
        ...
        if object_type:
            ...
            raise ValueError("LastReservation failed to lookup discriminator value from " +
...
LastReservation.update_forward_refs()
