...
class TravelerResponse(BaseModel):
    ...
    TravelerResponse
    """
    traveler: Optional[TravelerID] = Field(None, alias="Traveler")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TravelerResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TravelerResponse:
        """Create an instance of TravelerResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TravelerResponse.parse_obj(obj)

        _obj = TravelerResponse.parse_obj({
