...
class Country(BaseModel):
    ...
    id: Optional[StrictStr] = Field(None, description="Use this id to internally identify this country in NextSteps")
    name: Optional[constr(strict=True, max_length=128)] = Field(None, description="The name or code of a country")
    code_context: Optional[constr(strict=True, max_length=32)] = Field(None, alias="codeContext", description="The source of a code")
    __properties = ["value", "id", "name", "codeContext"]
