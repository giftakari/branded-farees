...
class FirstReservation(BaseModel):
    """
    FirstReservation
    """
    ...
    __discriminator_value_class_map = {
        'FirstReservationDayOfWeek': 'FirstReservationDayOfWeek',
        'FirstReservationDuration': 'FirstReservationDuration'
    }
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Union(FirstReservationDayOfWeek, FirstReservationDuration):
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Union(FirstReservationDayOfWeek, FirstReservationDuration):
        ...
        if object_type:
            ...
            raise ValueError("FirstReservation failed to lookup discriminator value from " +
...
FirstReservation.update_forward_refs()
