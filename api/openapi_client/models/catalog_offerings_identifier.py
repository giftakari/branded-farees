...
class CatalogOfferingsIdentifier(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CatalogOfferingsIdentifier:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CatalogOfferingsIdentifier:
        """Create an instance of CatalogOfferingsIdentifier from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CatalogOfferingsIdentifier.parse_obj(obj)

        _obj = CatalogOfferingsIdentifier.parse_obj({
            "id": obj.get("id"),
