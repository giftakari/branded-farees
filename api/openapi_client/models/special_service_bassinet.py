...
class SpecialServiceBassinet(SpecialService):
    """
    SpecialServiceBassinet
    """
    bassinet_required_ind: Optional[StrictBool] = Field(None, alias="bassinetRequiredInd", description="If true, a bassinet is required")
    __properties = ["@type", "id", "Identifier", "AppliesTo", "Status", "ServiceAnimalType", "TravelerIdentifier", "bassinetRequiredInd"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SpecialServiceBassinet:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SpecialServiceBassinet:
        """Create an instance of SpecialServiceBassinet from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SpecialServiceBassinet.parse_obj(obj)

        _obj = SpecialServiceBassinet.parse_obj({
            "type": obj.get("@type"),
            "id": obj.get("id"),
            ...
            "bassinet_required_ind": obj.get("bassinetRequiredInd")
        })
        return _obj
