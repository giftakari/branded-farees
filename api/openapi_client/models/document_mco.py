...
class DocumentMCO(Document):
    """
    DocumentMCO
    """
    mco_ind: Optional[StrictBool] = Field(None, alias="mcoInd", description="If true, the document issues is an MCO")
    __properties = ["@type", "Number", "TravelerIdentifierRef", "Amount", "WaiverCode", "Commission", "CumulativeValue", "IssuingPCC", "IssuingIATA", "IssuingCity", "FiledAmount", "mcoInd"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocumentMCO:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocumentMCO:
        """Create an instance of DocumentMCO from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocumentMCO.parse_obj(obj)

        _obj = DocumentMCO.parse_obj({
            "type": obj.get("@type"),
