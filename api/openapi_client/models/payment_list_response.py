...
class PaymentListResponse(BaseModel):
    ...
    PaymentListResponse
    """
    payment_id: Optional[conlist(PaymentID, max_items=100)] = Field(None, alias="PaymentID")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaymentListResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaymentListResponse:
        """Create an instance of PaymentListResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaymentListResponse.parse_obj(obj)

        _obj = PaymentListResponse.parse_obj({
