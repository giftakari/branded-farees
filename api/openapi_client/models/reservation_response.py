...
class ReservationResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReservationResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReservationResponse:
        """Create an instance of ReservationResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReservationResponse.parse_obj(obj)

        _obj = ReservationResponse.parse_obj({
