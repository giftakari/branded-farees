...
class BrandText(BaseModel):
    ...
    __discriminator_value_class_map = {
        'BrandTextDetail': 'BrandTextDetail'
    }
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Union(BrandTextDetail):
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Union(BrandTextDetail):
        ...
        if object_type:
            ...
            raise ValueError("BrandText failed to lookup discriminator value from " +
                             json.dumps(obj) + ". Discriminator property name: " + cls.__discriminator_property_name +
                             ", mapping: " + json.dumps(cls.__discriminator_value_class_map))

from openapi_client.models.brand_text_detail import BrandTextDetail
BrandText.update_forward_refs()
