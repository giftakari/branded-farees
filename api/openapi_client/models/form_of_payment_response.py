...
class FormOfPaymentResponse(BaseModel):
    """
    FormOfPaymentResponse
    """
    form_of_payment: Optional[FormOfPaymentID] = Field(None, alias="FormOfPayment")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FormOfPaymentResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FormOfPaymentResponse:
        """Create an instance of FormOfPaymentResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FormOfPaymentResponse.parse_obj(obj)

        _obj = FormOfPaymentResponse.parse_obj({
