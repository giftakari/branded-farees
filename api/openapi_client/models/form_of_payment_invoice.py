...
class FormOfPaymentInvoice(FormOfPaymentID):
    """
    FormOfPaymentInvoice
    """
    invoice_number: Optional[constr(strict=True, max_length=32)] = Field(None, alias="InvoiceNumber", description="The invoice number applicable to this form of payment. Send null or empty string if no invoice number specified.")
    __properties = ["@type", "id", "FormOfPaymentRef", "Identifier", "InvoiceNumber"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FormOfPaymentInvoice:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FormOfPaymentInvoice:
        """Create an instance of FormOfPaymentInvoice from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FormOfPaymentInvoice.parse_obj(obj)

        _obj = FormOfPaymentInvoice.parse_obj({
            "type": obj.get("@type"),
            "id": obj.get("id"),
