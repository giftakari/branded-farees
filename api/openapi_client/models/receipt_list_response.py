...
class ReceiptListResponse(BaseModel):
    ...
    ReceiptListResponse
    """
    receipt_id: Optional[conlist(Receipt, max_items=100)] = Field(None, alias="ReceiptID")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReceiptListResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReceiptListResponse:
        """Create an instance of ReceiptListResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReceiptListResponse.parse_obj(obj)

        _obj = ReceiptListResponse.parse_obj({
