...
class FormOfPaymentID(BaseModel):
    """
    FormOfPaymentID
    """
    type: StrictStr = Field(..., alias="@type")
    id: Optional[StrictStr] = None
    form_of_payment_ref: Optional[StrictStr] = Field(None, alias="FormOfPaymentRef")
    ...
    __discriminator_value_class_map = {
        'FormOfPaymentAgencyAccount': 'FormOfPaymentAgencyAccount',
        'FormOfPaymentBSP': 'FormOfPaymentBSP',
        'FormOfPaymentCash': 'FormOfPaymentCash',
        'FormOfPaymentDocument': 'FormOfPaymentDocument',
        'FormOfPaymentForfeit': 'FormOfPaymentForfeit',
        'FormOfPaymentInvoice': 'FormOfPaymentInvoice',
        'FormOfPaymentPaymentCard': 'FormOfPaymentPaymentCard',
        'FormOfPaymentVirtualPaymentAccount': 'FormOfPaymentVirtualPaymentAccount',
        'FormOfPaymentWaiverCode': 'FormOfPaymentWaiverCode'
    }
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Union(FormOfPaymentAgencyAccount, FormOfPaymentBSP, FormOfPaymentCash, FormOfPaymentDocument, FormOfPaymentForfeit, FormOfPaymentInvoice, FormOfPaymentPaymentCard, FormOfPaymentVirtualPaymentAccount, FormOfPaymentWaiverCode):
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Union(FormOfPaymentAgencyAccount, FormOfPaymentBSP, FormOfPaymentCash, FormOfPaymentDocument, FormOfPaymentForfeit, FormOfPaymentInvoice, FormOfPaymentPaymentCard, FormOfPaymentVirtualPaymentAccount, FormOfPaymentWaiverCode):
        ...
        if object_type:
            ...
            raise ValueError("FormOfPaymentID failed to lookup discriminator value from " +
...
FormOfPaymentID.update_forward_refs()
