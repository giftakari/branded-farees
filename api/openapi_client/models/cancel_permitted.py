...
class CancelPermitted(Cancel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CancelPermitted:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CancelPermitted:
        """Create an instance of CancelPermitted from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CancelPermitted.parse_obj(obj)

        _obj = CancelPermitted.parse_obj({
            "type": obj.get("@type"),
