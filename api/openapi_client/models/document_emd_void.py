...
class DocumentEMDVoid(Document):
    """
    DocumentEMDVoid
    """
    void_ind: Optional[StrictBool] = Field(None, alias="VoidInd", description="If true the EMD has been voided")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocumentEMDVoid:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocumentEMDVoid:
        """Create an instance of DocumentEMDVoid from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocumentEMDVoid.parse_obj(obj)

        _obj = DocumentEMDVoid.parse_obj({
            "type": obj.get("@type"),
