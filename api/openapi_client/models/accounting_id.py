...
class AccountingID(BaseModel):
    """
    AccountingID
    """
    type: StrictStr = Field(..., alias="@type")
    id: Optional[StrictStr] = None
    accounting_ref: Optional[StrictStr] = Field(None, alias="AccountingRef", description="Accounting reference")
    identifier: Optional[Identifier] = Field(None, alias="Identifier")
    __properties = ["@type", "id", "AccountingRef", "Identifier"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Union(Accounting):
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Union(Accounting):
        ...
        if object_type:
            ...
            raise ValueError("AccountingID failed to lookup discriminator value from " +
                             json.dumps(obj) + ". Discriminator property name: " + cls.__discriminator_property_name +
                             ", mapping: " + json.dumps(cls.__discriminator_value_class_map))

from openapi_client.models.accounting import Accounting
AccountingID.update_forward_refs()
