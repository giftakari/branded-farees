...
class OrganizationLoyaltyProgramID(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Union(OrganizationLoyaltyProgram):
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Union(OrganizationLoyaltyProgram):
        ...
        if object_type:
            ...
            raise ValueError("OrganizationLoyaltyProgramID failed to lookup discriminator value from " +
                             json.dumps(obj) + ". Discriminator property name: " + cls.__discriminator_property_name +
                             ", mapping: " + json.dumps(cls.__discriminator_value_class_map))

from openapi_client.models.organization_loyalty_program import OrganizationLoyaltyProgram
OrganizationLoyaltyProgramID.update_forward_refs()
