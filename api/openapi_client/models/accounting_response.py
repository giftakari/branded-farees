...
class AccountingResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AccountingResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AccountingResponse:
        """Create an instance of AccountingResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AccountingResponse.parse_obj(obj)

        _obj = AccountingResponse.parse_obj({
