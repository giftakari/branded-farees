...
class ModifyPrice(BaseModel):
    ...
    __discriminator_value_class_map = {
        'ModifyPriceDetail': 'ModifyPriceDetail'
    }
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Union(ModifyPriceDetail):
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Union(ModifyPriceDetail):
        ...
        if object_type:
            ...
            raise ValueError("ModifyPrice failed to lookup discriminator value from " +
                             json.dumps(obj) + ". Discriminator property name: " + cls.__discriminator_property_name +
                             ", mapping: " + json.dumps(cls.__discriminator_value_class_map))

from openapi_client.models.modify_price_detail import ModifyPriceDetail
ModifyPrice.update_forward_refs()
