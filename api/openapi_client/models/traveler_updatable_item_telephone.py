...
class TravelerUpdatableItemTelephone(TravelerUpdatableItem):
    """
    TravelerUpdatableItemTelephone
    """
    telephone: Optional[Telephone] = Field(None, alias="Telephone")
    __properties = ["@type", "Identifier", "addableInd", "modifiableInd", "deletableInd", "Telephone"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TravelerUpdatableItemTelephone:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TravelerUpdatableItemTelephone:
        """Create an instance of TravelerUpdatableItemTelephone from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TravelerUpdatableItemTelephone.parse_obj(obj)

        _obj = TravelerUpdatableItemTelephone.parse_obj({
            "type": obj.get("@type"),
