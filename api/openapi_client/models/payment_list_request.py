...
class PaymentListRequest(BaseModel):
    ...
    PaymentListRequest
    """
    payment: conlist(Payment, max_items=100, min_items=1) = Field(..., alias="Payment")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaymentListRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaymentListRequest:
        """Create an instance of PaymentListRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaymentListRequest.parse_obj(obj)

        _obj = PaymentListRequest.parse_obj({
