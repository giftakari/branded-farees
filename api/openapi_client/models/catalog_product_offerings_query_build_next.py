...
class CatalogProductOfferingsQueryBuildNext(BaseModel):
    """
    ...
    __properties = ["@type", "BuildFromCatalogProductOfferingsRequest"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CatalogProductOfferingsQueryBuildNext:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CatalogProductOfferingsQueryBuildNext:
        """Create an instance of CatalogProductOfferingsQueryBuildNext from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CatalogProductOfferingsQueryBuildNext.parse_obj(obj)

        _obj = CatalogProductOfferingsQueryBuildNext.parse_obj({
            "type": obj.get("@type"),
