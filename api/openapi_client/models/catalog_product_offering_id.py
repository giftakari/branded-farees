...
class CatalogProductOfferingID(BaseModel):
    """
    ...
    __properties = ["@type", "id", "Identifier", "CatalogProductOfferingRef"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Union(CatalogProductOffering):
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Union(CatalogProductOffering):
        ...
        if object_type:
            ...
            raise ValueError("CatalogProductOfferingID failed to lookup discriminator value from " +
...
CatalogProductOfferingID.update_forward_refs()
