...
class SpecialServiceBlind(SpecialService):
    """
    SpecialServiceBlind
    """
    blind_assistance_requested_ind: Optional[StrictBool] = Field(None, alias="blindAssistanceRequestedInd", description="If true the Traveler is Blind and requests assistance")
    __properties = ["@type", "id", "Identifier", "AppliesTo", "Status", "ServiceAnimalType", "TravelerIdentifier", "blindAssistanceRequestedInd"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SpecialServiceBlind:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SpecialServiceBlind:
        """Create an instance of SpecialServiceBlind from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SpecialServiceBlind.parse_obj(obj)

        _obj = SpecialServiceBlind.parse_obj({
            "type": obj.get("@type"),
            "id": obj.get("id"),
            ...
            "blind_assistance_requested_ind": obj.get("blindAssistanceRequestedInd")
        })
        return _obj
