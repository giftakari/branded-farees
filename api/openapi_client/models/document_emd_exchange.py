...
class DocumentEMDExchange(Document):
    """
    DocumentEMDExchange
    """
    ...
    __properties = ["@type", "Number", "TravelerIdentifierRef", "Amount", "WaiverCode", "Commission", "CumulativeValue", "IssuingPCC", "IssuingIATA", "IssuingCity", "FiledAmount", "exchangeInd"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocumentEMDExchange:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocumentEMDExchange:
        """Create an instance of DocumentEMDExchange from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocumentEMDExchange.parse_obj(obj)

        _obj = DocumentEMDExchange.parse_obj({
            "type": obj.get("@type"),
