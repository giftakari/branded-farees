...
class OperationalStatusENUMBase(str, Enum):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OperationalStatusENUMBase:
        """Create an instance of OperationalStatusENUMBase from a JSON string"""
        return OperationalStatusENUMBase(json.loads(json_str))
