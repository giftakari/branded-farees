...
class ReservationCommentID(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Union(ReservationComment):
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Union(ReservationComment):
        ...
        if object_type:
            ...
            raise ValueError("ReservationCommentID failed to lookup discriminator value from " +
                             json.dumps(obj) + ". Discriminator property name: " + cls.__discriminator_property_name +
                             ", mapping: " + json.dumps(cls.__discriminator_value_class_map))

from openapi_client.models.reservation_comment import ReservationComment
ReservationCommentID.update_forward_refs()
