...
class ProductQueryBuildFromCatalogProductOfferings(BaseModel):
    """
    ...
    __properties = ["BuildFromCatalogProductOfferingsRequest"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProductQueryBuildFromCatalogProductOfferings:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProductQueryBuildFromCatalogProductOfferings:
        """Create an instance of ProductQueryBuildFromCatalogProductOfferings from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProductQueryBuildFromCatalogProductOfferings.parse_obj(obj)

        _obj = ProductQueryBuildFromCatalogProductOfferings.parse_obj({
