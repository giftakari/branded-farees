...
class MagneticStripe(BaseModel):
    """
    MagneticStripe
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MagneticStripe:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MagneticStripe:
        """Create an instance of MagneticStripe from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MagneticStripe.parse_obj(obj)

        _obj = MagneticStripe.parse_obj({
            "type": obj.get("@type"),
