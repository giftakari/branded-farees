...
class FormOfPaymentBSP(FormOfPaymentID):
    """
    FormOfPaymentBSP
    """
    account_number: Optional[constr(strict=True, max_length=32)] = Field(None, alias="accountNumber", description="The account number for the Form of payment BSP")
    __properties = ["@type", "id", "FormOfPaymentRef", "Identifier", "accountNumber"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FormOfPaymentBSP:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FormOfPaymentBSP:
        """Create an instance of FormOfPaymentBSP from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FormOfPaymentBSP.parse_obj(obj)

        _obj = FormOfPaymentBSP.parse_obj({
            "type": obj.get("@type"),
            "id": obj.get("id"),
