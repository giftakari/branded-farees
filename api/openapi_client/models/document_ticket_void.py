...
class DocumentTicketVoid(Document):
    """
    DocumentTicketVoid
    """
    void_ind: Optional[StrictBool] = Field(None, alias="VoidInd", description="If true the document has been voided")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocumentTicketVoid:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocumentTicketVoid:
        """Create an instance of DocumentTicketVoid from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocumentTicketVoid.parse_obj(obj)

        _obj = DocumentTicketVoid.parse_obj({
            "type": obj.get("@type"),
