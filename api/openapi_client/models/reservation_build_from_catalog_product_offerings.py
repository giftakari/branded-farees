...
class ReservationBuildFromCatalogProductOfferings(ReservationBuild):
    """
    ...
    __properties = ["@type", "Traveler", "FormOfPayment", "Payment", "ReservationComment", "PrimaryContact", "SpecialService", "Accounting", "DocumentOverrides", "Preference", "ReceiptConfirmation", "TravelAgency", "BuildFromCatalogProductOfferingsRequest"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReservationBuildFromCatalogProductOfferings:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReservationBuildFromCatalogProductOfferings:
        """Create an instance of ReservationBuildFromCatalogProductOfferings from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReservationBuildFromCatalogProductOfferings.parse_obj(obj)

        _obj = ReservationBuildFromCatalogProductOfferings.parse_obj({
            "type": obj.get("@type"),
