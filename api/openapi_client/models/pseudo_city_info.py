...
class PseudoCityInfo(BaseModel):
    """
    ...
    """
    value: Optional[constr(strict=True, max_length=10, min_length=2)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PseudoCityInfo:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PseudoCityInfo:
        """Create an instance of PseudoCityInfo from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PseudoCityInfo.parse_obj(obj)

        _obj = PseudoCityInfo.parse_obj({
            "value": obj.get("value"),
