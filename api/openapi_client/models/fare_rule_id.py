...
class FareRuleID(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Union(FareRule, FareRuleStructured, FareRuleText):
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Union(FareRule, FareRuleStructured, FareRuleText):
        ...
        if object_type:
            ...
            raise ValueError("FareRuleID failed to lookup discriminator value from " +
...
FareRuleID.update_forward_refs()
