...
class OfferListResponse(BaseModel):
    ...
    OfferListResponse
    """
    offer_id: Optional[conlist(OfferID, max_items=1000)] = Field(None, alias="OfferID")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OfferListResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OfferListResponse:
        """Create an instance of OfferListResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OfferListResponse.parse_obj(obj)

        _obj = OfferListResponse.parse_obj({
