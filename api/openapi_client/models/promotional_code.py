...
class PromotionalCode(BaseModel):
    ...
    supplier_code: constr(strict=True, max_length=5, min_length=2) = Field(..., alias="supplierCode", description="Promotional code supplier code")
    __properties = ["value", "supplierCode"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PromotionalCode:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PromotionalCode:
        """Create an instance of PromotionalCode from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PromotionalCode.parse_obj(obj)

        _obj = PromotionalCode.parse_obj({
            "value": obj.get("value"),
