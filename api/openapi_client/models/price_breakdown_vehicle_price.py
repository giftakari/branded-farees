...
class PriceBreakdownVehiclePrice(PriceBreakdown):
    """
    PriceBreakdownVehiclePrice
    """
    vehicle_price: VehiclePrice = Field(..., alias="VehiclePrice")
    rate_guaranteed_ind: Optional[StrictBool] = Field(None, alias="rateGuaranteedInd")
    __properties = ["@type", "Amount", "Commission", "VehiclePrice", "rateGuaranteedInd"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PriceBreakdownVehiclePrice:
    ...
    def to_dict(self):
        ...
        # override the default output from pydantic by calling `to_dict()` of vehicle_price
        if self.vehicle_price:
            _dict['VehiclePrice'] = self.vehicle_price.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> PriceBreakdownVehiclePrice:
        """Create an instance of PriceBreakdownVehiclePrice from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PriceBreakdownVehiclePrice.parse_obj(obj)

        _obj = PriceBreakdownVehiclePrice.parse_obj({
            "type": obj.get("@type"),
            ...
            "vehicle_price": VehiclePrice.from_dict(obj.get("VehiclePrice")) if obj.get("VehiclePrice") is not None else None,
