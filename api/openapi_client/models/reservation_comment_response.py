...
class ReservationCommentResponse(BaseModel):
    """
    ReservationCommentResponse
    """
    reservation_comment: Optional[ReservationCommentID] = Field(None, alias="ReservationComment")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReservationCommentResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReservationCommentResponse:
        """Create an instance of ReservationCommentResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReservationCommentResponse.parse_obj(obj)

        _obj = ReservationCommentResponse.parse_obj({
