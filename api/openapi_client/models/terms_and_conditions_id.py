...
class TermsAndConditionsID(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Union(TermsAndConditions, TermsAndConditionsAir):
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Union(TermsAndConditions, TermsAndConditionsAir):
        ...
        if object_type:
            ...
            raise ValueError("TermsAndConditionsID failed to lookup discriminator value from " +
...
TermsAndConditionsID.update_forward_refs()
