...
class OrganizationLoyaltyProgramListResponse(BaseModel):
    """
    OrganizationLoyaltyProgramListResponse
    """
    organization_loyalty_program: Optional[conlist(OrganizationLoyaltyProgramID, max_items=10)] = Field(None, alias="OrganizationLoyaltyProgram")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OrganizationLoyaltyProgramListResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OrganizationLoyaltyProgramListResponse:
        """Create an instance of OrganizationLoyaltyProgramListResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OrganizationLoyaltyProgramListResponse.parse_obj(obj)

        _obj = OrganizationLoyaltyProgramListResponse.parse_obj({
