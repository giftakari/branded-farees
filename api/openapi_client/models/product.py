...
class Product(ProductID):
    ...
    __properties = ["@type", "id", "productRef", "Identifier", "Quantity"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Union(ProductAir, ProductAncillary, ProductAncillaryVehicle, ProductHospitality, ProductVehicle):
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Union(ProductAir, ProductAncillary, ProductAncillaryVehicle, ProductHospitality, ProductVehicle):
        ...
        if object_type:
            ...
            raise ValueError("Product failed to lookup discriminator value from " +
