...
class Ancillary(BaseModel):
    ...
    description: conlist(AncillaryDescription, max_items=10, min_items=1) = Field(..., alias="Description")
    __properties = ["@type", "quantity", "Description"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Union(AncillaryAir, AncillaryAirBaggage, AncillaryAirSeat):
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Union(AncillaryAir, AncillaryAirBaggage, AncillaryAirSeat):
        ...
        if object_type:
            ...
            raise ValueError("Ancillary failed to lookup discriminator value from " +
