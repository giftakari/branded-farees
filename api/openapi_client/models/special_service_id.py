...
class SpecialServiceID(BaseModel):
    """
    SpecialServiceID
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Union(SpecialService, SpecialServiceBassinet, SpecialServiceBlind, SpecialServiceDPNA, SpecialServiceDeaf, SpecialServiceMeal, SpecialServiceUnaccompaniedMinor, SpecialServiceWheelchairAirlineSupplied, SpecialServiceWheelchairTravelerSupplied):
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Union(SpecialService, SpecialServiceBassinet, SpecialServiceBlind, SpecialServiceDPNA, SpecialServiceDeaf, SpecialServiceMeal, SpecialServiceUnaccompaniedMinor, SpecialServiceWheelchairAirlineSupplied, SpecialServiceWheelchairTravelerSupplied):
        ...
        if object_type:
            ...
            raise ValueError("SpecialServiceID failed to lookup discriminator value from " +
...
SpecialServiceID.update_forward_refs()
