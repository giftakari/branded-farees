...
class BestCombinablePriceDetail(BestCombinablePrice):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BestCombinablePriceDetail:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BestCombinablePriceDetail:
        """Create an instance of BestCombinablePriceDetail from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BestCombinablePriceDetail.parse_obj(obj)

        _obj = BestCombinablePriceDetail.parse_obj({
            "type": obj.get("@type"),
            "id": obj.get("id"),
