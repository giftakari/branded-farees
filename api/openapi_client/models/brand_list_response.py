...
class BrandListResponse(BaseModel):
    ...
    BrandListResponse
    """
    brand_id: Optional[conlist(BrandCompleteInfo, max_items=100)] = Field(None, alias="BrandID")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BrandListResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BrandListResponse:
        """Create an instance of BrandListResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BrandListResponse.parse_obj(obj)

        _obj = BrandListResponse.parse_obj({
