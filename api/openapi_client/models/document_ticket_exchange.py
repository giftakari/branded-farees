...
class DocumentTicketExchange(Document):
    """
    DocumentTicketExchange
    """
    exchange_ind: Optional[StrictBool] = Field(None, alias="exchangeInd", description="If true this document has been exchanged for a new document")
    historic_ind: Optional[StrictBool] = Field(None, alias="historicInd", description="if true this document exchange has been cancelled/voided")
    __properties = ["@type", "Number", "TravelerIdentifierRef", "Amount", "WaiverCode", "Commission", "CumulativeValue", "IssuingPCC", "IssuingIATA", "IssuingCity", "FiledAmount", "exchangeInd", "historicInd"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocumentTicketExchange:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocumentTicketExchange:
        """Create an instance of DocumentTicketExchange from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocumentTicketExchange.parse_obj(obj)

        _obj = DocumentTicketExchange.parse_obj({
            "type": obj.get("@type"),
            ...
            "exchange_ind": obj.get("exchangeInd"),
