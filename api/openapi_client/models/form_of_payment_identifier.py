...
class FormOfPaymentIdentifier(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FormOfPaymentIdentifier:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FormOfPaymentIdentifier:
        """Create an instance of FormOfPaymentIdentifier from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FormOfPaymentIdentifier.parse_obj(obj)

        _obj = FormOfPaymentIdentifier.parse_obj({
            "type": obj.get("@type"),
            "id": obj.get("id"),
