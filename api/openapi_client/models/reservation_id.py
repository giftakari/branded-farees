...
class ReservationID(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Union(Reservation, ReservationDetail):
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Union(Reservation, ReservationDetail):
        ...
        if object_type:
            ...
            raise ValueError("ReservationID failed to lookup discriminator value from " +
...
ReservationID.update_forward_refs()
