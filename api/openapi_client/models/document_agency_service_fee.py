...
class DocumentAgencyServiceFee(Document):
    """
    DocumentAgencyServiceFee
    """
    related_document_number: Optional[DocumentNumber] = Field(None, alias="RelatedDocumentNumber")
    __properties = ["@type", "Number", "TravelerIdentifierRef", "Amount", "WaiverCode", "Commission", "CumulativeValue", "IssuingPCC", "IssuingIATA", "IssuingCity", "FiledAmount", "RelatedDocumentNumber"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocumentAgencyServiceFee:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocumentAgencyServiceFee:
        """Create an instance of DocumentAgencyServiceFee from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocumentAgencyServiceFee.parse_obj(obj)

        _obj = DocumentAgencyServiceFee.parse_obj({
            "type": obj.get("@type"),
