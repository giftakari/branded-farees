...
class FeeAmountOrPercentPercent(FeeAmountOrPercent):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FeeAmountOrPercentPercent:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FeeAmountOrPercentPercent:
        """Create an instance of FeeAmountOrPercentPercent from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FeeAmountOrPercentPercent.parse_obj(obj)

        _obj = FeeAmountOrPercentPercent.parse_obj({
            "type": obj.get("@type"),
