...
class TravelerUpdatableItemsListResponse(BaseModel):
    """
    TravelerUpdatableItemsListResponse
    """
    traveler_updatable_items_id: Optional[conlist(TravelerUpdatableItemsID, max_items=100)] = Field(None, alias="TravelerUpdatableItemsID")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TravelerUpdatableItemsListResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TravelerUpdatableItemsListResponse:
        """Create an instance of TravelerUpdatableItemsListResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TravelerUpdatableItemsListResponse.parse_obj(obj)

        _obj = TravelerUpdatableItemsListResponse.parse_obj({
