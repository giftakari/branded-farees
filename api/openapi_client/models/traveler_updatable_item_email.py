...
class TravelerUpdatableItemEmail(TravelerUpdatableItem):
    """
    TravelerUpdatableItemEmail
    """
    email: Optional[Email] = Field(None, alias="Email")
    __properties = ["@type", "Identifier", "addableInd", "modifiableInd", "deletableInd", "Email"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TravelerUpdatableItemEmail:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TravelerUpdatableItemEmail:
        """Create an instance of TravelerUpdatableItemEmail from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TravelerUpdatableItemEmail.parse_obj(obj)

        _obj = TravelerUpdatableItemEmail.parse_obj({
            "type": obj.get("@type"),
