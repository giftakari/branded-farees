...
class ReservationBuildFromCatalogOfferingsAir(ReservationBuildFromCatalogOfferings):
    """
    ReservationBuildFromCatalogOfferingsAir
    """
    pricing_modifiers_air: PricingModifiersAir = Field(..., alias="PricingModifiersAir")
    __properties = ["@type", "Traveler", "FormOfPayment", "Payment", "ReservationComment", "PrimaryContact", "SpecialService", "Accounting", "DocumentOverrides", "Preference", "ReceiptConfirmation", "TravelAgency", "BuildFromCatalogOfferingsRequest", "PricingModifiersAir"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReservationBuildFromCatalogOfferingsAir:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReservationBuildFromCatalogOfferingsAir:
        """Create an instance of ReservationBuildFromCatalogOfferingsAir from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReservationBuildFromCatalogOfferingsAir.parse_obj(obj)

        _obj = ReservationBuildFromCatalogOfferingsAir.parse_obj({
            "type": obj.get("@type"),
