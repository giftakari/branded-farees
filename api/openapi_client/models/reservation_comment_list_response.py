...
class ReservationCommentListResponse(BaseModel):
    """
    ReservationCommentListResponse
    """
    reservation_comment_id: Optional[conlist(ReservationCommentID, max_items=1000)] = Field(None, alias="ReservationCommentID")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReservationCommentListResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReservationCommentListResponse:
        """Create an instance of ReservationCommentListResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReservationCommentListResponse.parse_obj(obj)

        _obj = ReservationCommentListResponse.parse_obj({
