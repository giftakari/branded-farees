...
class TravelerListResponse(BaseModel):
    ...
    """
    traveler_id: Optional[conlist(TravelerID, max_items=100)] = Field(None, alias="TravelerID")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TravelerListResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TravelerListResponse:
        """Create an instance of TravelerListResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TravelerListResponse.parse_obj(obj)

        _obj = TravelerListResponse.parse_obj({
