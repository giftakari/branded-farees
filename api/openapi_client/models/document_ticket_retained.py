...
class DocumentTicketRetained(Document):
    """
    DocumentTicketRetained
    """
    value_retained_ind: Optional[StrictBool] = Field(None, alias="ValueRetainedInd", description="If true the Document Ticket Value has been retained for future use")
    __properties = ["@type", "Number", "TravelerIdentifierRef", "Amount", "WaiverCode", "Commission", "CumulativeValue", "IssuingPCC", "IssuingIATA", "IssuingCity", "FiledAmount", "ValueRetainedInd"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocumentTicketRetained:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocumentTicketRetained:
        """Create an instance of DocumentTicketRetained from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocumentTicketRetained.parse_obj(obj)

        _obj = DocumentTicketRetained.parse_obj({
            "type": obj.get("@type"),
            ...
            "value_retained_ind": obj.get("ValueRetainedInd")
        })
        return _obj
