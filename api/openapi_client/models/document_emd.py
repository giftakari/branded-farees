...
class DocumentEMD(Document):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocumentEMD:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocumentEMD:
        """Create an instance of DocumentEMD from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocumentEMD.parse_obj(obj)

        _obj = DocumentEMD.parse_obj({
            "type": obj.get("@type"),
