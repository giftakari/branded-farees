...
class UpsellOfferingIdentifier(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpsellOfferingIdentifier:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpsellOfferingIdentifier:
        """Create an instance of UpsellOfferingIdentifier from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpsellOfferingIdentifier.parse_obj(obj)

        _obj = UpsellOfferingIdentifier.parse_obj({
            "id": obj.get("id"),
