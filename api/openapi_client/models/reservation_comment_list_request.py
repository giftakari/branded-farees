...
class ReservationCommentListRequest(BaseModel):
    """
    ReservationCommentListRequest
    """
    reservation_comment: conlist(ReservationComment, max_items=100, min_items=1) = Field(..., alias="ReservationComment")
    __properties = ["ReservationComment"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReservationCommentListRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReservationCommentListRequest:
        """Create an instance of ReservationCommentListRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReservationCommentListRequest.parse_obj(obj)

        _obj = ReservationCommentListRequest.parse_obj({
