...
class SpecialServiceMeal(SpecialService):
    """
    SpecialServiceMeal
    """
    special_meal_type_enum: Optional[SpecialMealTypeEnum] = Field(None, alias="SpecialMealTypeEnum")
    __properties = ["@type", "id", "Identifier", "AppliesTo", "Status", "ServiceAnimalType", "TravelerIdentifier", "SpecialMealTypeEnum"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SpecialServiceMeal:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SpecialServiceMeal:
        """Create an instance of SpecialServiceMeal from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SpecialServiceMeal.parse_obj(obj)

        _obj = SpecialServiceMeal.parse_obj({
            "type": obj.get("@type"),
            "id": obj.get("id"),
            ...
            "special_meal_type_enum": obj.get("SpecialMealTypeEnum")
        })
        return _obj
