...
class OfferQueryBuildAncillaryOffersFromCatalogOfferings(BaseModel):
    """
    OfferQueryBuildAncillaryOffersFromCatalogOfferings
    """
    type: StrictStr = Field(..., alias="@type")
    build_ancillary_offers_from_catalog_offerings: conlist(BuildAncillaryOffersFromCatalogOfferings, max_items=1000, min_items=1) = Field(..., alias="BuildAncillaryOffersFromCatalogOfferings")
    __properties = ["@type", "BuildAncillaryOffersFromCatalogOfferings"]
    ...
    __discriminator_value_class_map = {
        'BuildAncillaryOffersFromCatalogOfferingsAirSeat': 'BuildAncillaryOffersFromCatalogOfferingsAirSeat'
    }
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Union(BuildAncillaryOffersFromCatalogOfferingsAirSeat):
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Union(BuildAncillaryOffersFromCatalogOfferingsAirSeat):
        ...
        if object_type:
            ...
            raise ValueError("OfferQueryBuildAncillaryOffersFromCatalogOfferings failed to lookup discriminator value from " +
...
OfferQueryBuildAncillaryOffersFromCatalogOfferings.update_forward_refs()
