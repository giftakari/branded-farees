...
class VendorCurrencyTotal(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VendorCurrencyTotal:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VendorCurrencyTotal:
        """Create an instance of VendorCurrencyTotal from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VendorCurrencyTotal.parse_obj(obj)

        _obj = VendorCurrencyTotal.parse_obj({
            "type": obj.get("@type"),
