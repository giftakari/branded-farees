...
class PrimaryContactResponse(BaseModel):
    ...
    """
    primary_contact: Optional[PrimaryContactID] = Field(None, alias="PrimaryContact")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PrimaryContactResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PrimaryContactResponse:
        """Create an instance of PrimaryContactResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PrimaryContactResponse.parse_obj(obj)

        _obj = PrimaryContactResponse.parse_obj({
