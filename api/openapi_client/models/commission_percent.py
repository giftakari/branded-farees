...
class CommissionPercent(Commission):
    """
    CommissionPercent
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CommissionPercent:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CommissionPercent:
        """Create an instance of CommissionPercent from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CommissionPercent.parse_obj(obj)

        _obj = CommissionPercent.parse_obj({
            "type": obj.get("@type"),
