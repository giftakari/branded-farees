...
class CatalogProductOfferingsID(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Union(CatalogProductOfferings):
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Union(CatalogProductOfferings):
        ...
        if object_type:
            ...
            raise ValueError("CatalogProductOfferingsID failed to lookup discriminator value from " +
                             json.dumps(obj) + ". Discriminator property name: " + cls.__discriminator_property_name +
                             ", mapping: " + json.dumps(cls.__discriminator_value_class_map))

from openapi_client.models.catalog_product_offerings import CatalogProductOfferings
CatalogProductOfferingsID.update_forward_refs()
