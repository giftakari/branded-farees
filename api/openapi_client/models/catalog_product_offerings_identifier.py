...
class CatalogProductOfferingsIdentifier(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CatalogProductOfferingsIdentifier:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CatalogProductOfferingsIdentifier:
        """Create an instance of CatalogProductOfferingsIdentifier from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CatalogProductOfferingsIdentifier.parse_obj(obj)

        _obj = CatalogProductOfferingsIdentifier.parse_obj({
            "id": obj.get("id"),
