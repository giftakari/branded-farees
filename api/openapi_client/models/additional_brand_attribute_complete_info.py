...
class AdditionalBrandAttributeCompleteInfo(AdditionalBrandAttribute):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AdditionalBrandAttributeCompleteInfo:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AdditionalBrandAttributeCompleteInfo:
        """Create an instance of AdditionalBrandAttributeCompleteInfo from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AdditionalBrandAttributeCompleteInfo.parse_obj(obj)

        _obj = AdditionalBrandAttributeCompleteInfo.parse_obj({
            "type": obj.get("@type"),
