...
class PenaltyAmount(Penalty):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PenaltyAmount:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PenaltyAmount:
        """Create an instance of PenaltyAmount from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PenaltyAmount.parse_obj(obj)

        _obj = PenaltyAmount.parse_obj({
            "type": obj.get("@type"),
