...
class TravelerID(BaseModel):
    """
    TravelerID
    """
    type: StrictStr = Field(..., alias="@type")
    id: Optional[StrictStr] = None
    traveler_ref: Optional[StrictStr] = Field(None, alias="TravelerRef")
    identifier: Optional[Identifier] = Field(None, alias="Identifier")
    __properties = ["@type", "id", "TravelerRef", "Identifier"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Union(Traveler):
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Union(Traveler):
        ...
        if object_type:
            ...
            raise ValueError("TravelerID failed to lookup discriminator value from " +
                             json.dumps(obj) + ". Discriminator property name: " + cls.__discriminator_property_name +
                             ", mapping: " + json.dumps(cls.__discriminator_value_class_map))

from openapi_client.models.traveler import Traveler
TravelerID.update_forward_refs()
