...
class AppliesToOffer(AppliesTo):
    """
    AppliesToOffer
    """
    offer_identifier: Optional[conlist(OfferIdentifier, max_items=1000)] = Field(None, alias="OfferIdentifier")
    __properties = ["@type", "OfferIdentifier"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AppliesToOffer:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AppliesToOffer:
        """Create an instance of AppliesToOffer from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AppliesToOffer.parse_obj(obj)

        _obj = AppliesToOffer.parse_obj({
            "type": obj.get("@type"),
