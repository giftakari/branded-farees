...
class CatalogOfferingsRequest(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CatalogOfferingsRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CatalogOfferingsRequest:
        """Create an instance of CatalogOfferingsRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CatalogOfferingsRequest.parse_obj(obj)

        _obj = CatalogOfferingsRequest.parse_obj({
            "type": obj.get("@type"),
