...
class ProductAncillary(Product):
    """
    ProductAncillary
    """
    ancillary: Optional[Ancillary] = Field(None, alias="Ancillary")
    selected_by_default_ind: Optional[StrictBool] = Field(None, alias="selectedByDefaultInd")
    __properties = ["@type", "id", "productRef", "Identifier", "Quantity", "Ancillary", "selectedByDefaultInd"]
    ...
    __discriminator_value_class_map = {
        'ProductAncillaryVehicle': 'ProductAncillaryVehicle'
    }
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Union(ProductAncillaryVehicle):
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Union(ProductAncillaryVehicle):
        ...
        if object_type:
            ...
            raise ValueError("ProductAncillary failed to lookup discriminator value from " +
                             json.dumps(obj) + ". Discriminator property name: " + cls.__discriminator_property_name +
                             ", mapping: " + json.dumps(cls.__discriminator_value_class_map))

from openapi_client.models.product_ancillary_vehicle import ProductAncillaryVehicle
ProductAncillary.update_forward_refs()
