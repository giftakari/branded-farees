...
class TicketListResponse(BaseModel):
    ...
    TicketListResponse
    """
    ticket_id: Optional[conlist(Ticket, max_items=100)] = Field(None, alias="TicketID")
    settlement_authorization_code: Optional[constr(strict=True, max_length=32)] = Field(None, alias="SettlementAuthorizationCode")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TicketListResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TicketListResponse:
        """Create an instance of TicketListResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TicketListResponse.parse_obj(obj)

        _obj = TicketListResponse.parse_obj({
