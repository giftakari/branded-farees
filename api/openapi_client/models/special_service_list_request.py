...
class SpecialServiceListRequest(BaseModel):
    """
    supports sending a list of SpecialService objects
    """
    special_service: conlist(SpecialService, min_items=1) = Field(..., alias="SpecialService")
    __properties = ["SpecialService"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SpecialServiceListRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SpecialServiceListRequest:
        """Create an instance of SpecialServiceListRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SpecialServiceListRequest.parse_obj(obj)

        _obj = SpecialServiceListRequest.parse_obj({
