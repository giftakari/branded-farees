...
class CancellationHold(Cancellation):
    """
    CancellationHold
    """
    locator: Optional[Locator] = Field(None, alias="Locator")
    __properties = ["@type", "Locator"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CancellationHold:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CancellationHold:
        """Create an instance of CancellationHold from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CancellationHold.parse_obj(obj)

        _obj = CancellationHold.parse_obj({
            "type": obj.get("@type"),
