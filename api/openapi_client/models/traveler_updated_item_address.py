...
class TravelerUpdatedItemAddress(TravelerUpdatedItem):
    """
    TravelerUpdatedItemAddress
    """
    address: Address = Field(..., alias="Address")
    __properties = ["@type", "TravelerUpdatableItemID", "addInd", "modifyInd", "deleteInd", "Address"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TravelerUpdatedItemAddress:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TravelerUpdatedItemAddress:
        """Create an instance of TravelerUpdatedItemAddress from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TravelerUpdatedItemAddress.parse_obj(obj)

        _obj = TravelerUpdatedItemAddress.parse_obj({
            "type": obj.get("@type"),
