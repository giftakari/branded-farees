...
class UpsellOfferingID(BaseModel):
    """
    UpsellOfferingID
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Union(UpsellOffering):
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Union(UpsellOffering):
        ...
        if object_type:
            ...
            raise ValueError("UpsellOfferingID failed to lookup discriminator value from " +
                             json.dumps(obj) + ". Discriminator property name: " + cls.__discriminator_property_name +
                             ", mapping: " + json.dumps(cls.__discriminator_value_class_map))

from openapi_client.models.upsell_offering import UpsellOffering
UpsellOfferingID.update_forward_refs()
