...
class CatalogProductOfferingsRequest(BaseModel):
    """
    ...
    __properties = ["@type", "SearchControlConsoleChannelID"]
    ...
    __discriminator_value_class_map = {
        'CatalogProductOfferingsRequestAir': 'CatalogProductOfferingsRequestAir'
    }
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Union(CatalogProductOfferingsRequestAir):
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Union(CatalogProductOfferingsRequestAir):
        ...
        if object_type:
            ...
            raise ValueError("CatalogProductOfferingsRequest failed to lookup discriminator value from " +
...
CatalogProductOfferingsRequest.update_forward_refs()
