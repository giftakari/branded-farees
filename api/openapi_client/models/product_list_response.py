...
class ProductListResponse(BaseModel):
    ...
    ProductListResponse
    """
    product: Optional[conlist(Product, max_items=100)] = Field(None, alias="Product")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProductListResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProductListResponse:
        """Create an instance of ProductListResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProductListResponse.parse_obj(obj)

        _obj = ProductListResponse.parse_obj({
