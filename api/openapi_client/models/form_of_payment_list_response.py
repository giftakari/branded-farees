...
class FormOfPaymentListResponse(BaseModel):
    """
    FormOfPaymentListResponse
    """
    form_of_payment_id: Optional[conlist(FormOfPaymentID, max_items=100)] = Field(None, alias="FormOfPaymentID")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FormOfPaymentListResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FormOfPaymentListResponse:
        """Create an instance of FormOfPaymentListResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FormOfPaymentListResponse.parse_obj(obj)

        _obj = FormOfPaymentListResponse.parse_obj({
