...
class ReceiptID(BaseModel):
    ...
    id: Optional[StrictStr] = Field(None, description="The verification number.")
    receipt_ref: Optional[StrictStr] = Field(None, alias="ReceiptRef")
    identifier: Optional[Identifier] = Field(None, alias="Identifier")
    __properties = ["@type", "id", "ReceiptRef", "Identifier"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Union(Receipt, ReceiptCancellation, ReceiptConfirmation, ReceiptConfirmationDivide, ReceiptPayment):
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Union(Receipt, ReceiptCancellation, ReceiptConfirmation, ReceiptConfirmationDivide, ReceiptPayment):
        ...
        if object_type:
            ...
            raise ValueError("ReceiptID failed to lookup discriminator value from " +
