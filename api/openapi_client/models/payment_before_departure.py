...
class PaymentBeforeDeparture(BaseModel):
    """
    ...
    __discriminator_value_class_map = {
        'PaymentBeforeDepartureDayOfWeek': 'PaymentBeforeDepartureDayOfWeek',
        'PaymentBeforeDepartureDuration': 'PaymentBeforeDepartureDuration'
    }
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Union(PaymentBeforeDepartureDayOfWeek, PaymentBeforeDepartureDuration):
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Union(PaymentBeforeDepartureDayOfWeek, PaymentBeforeDepartureDuration):
        ...
        if object_type:
            ...
            raise ValueError("PaymentBeforeDeparture failed to lookup discriminator value from " +
...
PaymentBeforeDeparture.update_forward_refs()
