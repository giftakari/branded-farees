...
class PrimaryContactListResponse(BaseModel):
    """
    PrimaryContactListResponse
    """
    primary_contact_id: Optional[conlist(PrimaryContactID, max_items=9)] = Field(None, alias="PrimaryContactID")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PrimaryContactListResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PrimaryContactListResponse:
        """Create an instance of PrimaryContactListResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PrimaryContactListResponse.parse_obj(obj)

        _obj = PrimaryContactListResponse.parse_obj({
