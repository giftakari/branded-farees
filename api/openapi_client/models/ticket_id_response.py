...
class TicketIdResponse(BaseModel):
    ...
    ticket: Optional[TicketID] = Field(None, alias="Ticket")
    settlement_authorization_code: constr(strict=True, max_length=32) = Field(..., alias="SettlementAuthorizationCode")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TicketIdResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TicketIdResponse:
        """Create an instance of TicketIdResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TicketIdResponse.parse_obj(obj)

        _obj = TicketIdResponse.parse_obj({
