...
class BestCombinablePrice(BaseModel):
    """
    BestCombinablePrice
    """
    ...
    __discriminator_value_class_map = {
        'BestCombinablePriceDetail': 'BestCombinablePriceDetail'
    }
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Union(BestCombinablePriceDetail):
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Union(BestCombinablePriceDetail):
        ...
        if object_type:
            ...
            raise ValueError("BestCombinablePrice failed to lookup discriminator value from " +
                             json.dumps(obj) + ". Discriminator property name: " + cls.__discriminator_property_name +
                             ", mapping: " + json.dumps(cls.__discriminator_value_class_map))

from openapi_client.models.best_combinable_price_detail import BestCombinablePriceDetail
BestCombinablePrice.update_forward_refs()
