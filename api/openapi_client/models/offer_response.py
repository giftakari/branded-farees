...
class OfferResponse(BaseModel):
    ...
    OfferResponse
    """
    offer: Optional[OfferID] = Field(None, alias="Offer")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OfferResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OfferResponse:
        """Create an instance of OfferResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OfferResponse.parse_obj(obj)

        _obj = OfferResponse.parse_obj({
