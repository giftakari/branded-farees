...
class DocumentEMDRefund(Document):
    """
    DocumentEMDRefund
    """
    emd_description: EMDDescription = Field(..., alias="EMDDescription")
    __properties = ["@type", "Number", "TravelerIdentifierRef", "Amount", "WaiverCode", "Commission", "CumulativeValue", "IssuingPCC", "IssuingIATA", "IssuingCity", "FiledAmount", "EMDDescription"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocumentEMDRefund:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocumentEMDRefund:
        """Create an instance of DocumentEMDRefund from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocumentEMDRefund.parse_obj(obj)

        _obj = DocumentEMDRefund.parse_obj({
            "type": obj.get("@type"),
