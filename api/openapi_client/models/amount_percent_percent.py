...
class AmountPercentPercent(AmountPercent):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AmountPercentPercent:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AmountPercentPercent:
        """Create an instance of AmountPercentPercent from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AmountPercentPercent.parse_obj(obj)

        _obj = AmountPercentPercent.parse_obj({
            "type": obj.get("@type"),
