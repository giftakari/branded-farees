...
class BuildFromCatalogProductOfferingsRequestAir(BaseModel):
    """
    ...
    __properties = ["@type", "CatalogProductOfferingsIdentifier", "CatalogProductOfferingSelection", "UpsellOfferingIdentifier", "PricingModifiersAir", "CabinPreference", "FareRuleCategory", "FareRuleType", "CustomResponseModifiersAir", "lowFareFinderInd", "reCheckInventoryInd", "inhibitBrandContentInd", "validateInventoryInd"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BuildFromCatalogProductOfferingsRequestAir:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BuildFromCatalogProductOfferingsRequestAir:
        """Create an instance of BuildFromCatalogProductOfferingsRequestAir from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BuildFromCatalogProductOfferingsRequestAir.parse_obj(obj)

        _obj = BuildFromCatalogProductOfferingsRequestAir.parse_obj({
            "type": obj.get("@type"),
