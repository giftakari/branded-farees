...
class AmountPercentAmount(AmountPercent):
    """
    AmountPercentAmount
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AmountPercentAmount:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AmountPercentAmount:
        """Create an instance of AmountPercentAmount from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AmountPercentAmount.parse_obj(obj)

        _obj = AmountPercentAmount.parse_obj({
            "type": obj.get("@type"),
