...
class TicketID(BaseModel):
    ...
    obj_id: Optional[StrictStr] = Field(None, alias="objID")
    ticket_ref: Optional[StrictStr] = Field(None, alias="TicketRef")
    identifier: Optional[Identifier] = Field(None, alias="Identifier")
    __properties = ["@type", "objID", "TicketRef", "Identifier"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Union(Ticket, TicketDetail):
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Union(Ticket, TicketDetail):
        ...
        if object_type:
            ...
            raise ValueError("TicketID failed to lookup discriminator value from " +
