...
class PaymentIdentifier(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaymentIdentifier:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaymentIdentifier:
        """Create an instance of PaymentIdentifier from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaymentIdentifier.parse_obj(obj)

        _obj = PaymentIdentifier.parse_obj({
            "type": obj.get("@type"),
            "id": obj.get("id"),
