...
class DayOfWeekDuration(BaseModel):
    """
    DayOfWeekDuration
    """
    ...
    __discriminator_value_class_map = {
        'DayOfWeekDurationDayOfWeek': 'DayOfWeekDurationDayOfWeek',
        'DayOfWeekDurationDuration': 'DayOfWeekDurationDuration'
    }
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Union(DayOfWeekDurationDayOfWeek, DayOfWeekDurationDuration):
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Union(DayOfWeekDurationDayOfWeek, DayOfWeekDurationDuration):
        ...
        if object_type:
            ...
            raise ValueError("DayOfWeekDuration failed to lookup discriminator value from " +
...
DayOfWeekDuration.update_forward_refs()
