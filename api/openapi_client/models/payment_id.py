...
class PaymentID(BaseModel):
    ...
    payment_ref: Optional[StrictStr] = Field(None, alias="PaymentRef")
    identifier: Optional[Identifier] = Field(None, alias="Identifier")
    __properties = ["@type", "id", "PaymentRef", "Identifier"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Union(Payment):
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Union(Payment):
        ...
        if object_type:
            ...
            raise ValueError("PaymentID failed to lookup discriminator value from " +
                             json.dumps(obj) + ". Discriminator property name: " + cls.__discriminator_property_name +
                             ", mapping: " + json.dumps(cls.__discriminator_value_class_map))

from openapi_client.models.payment import Payment
PaymentID.update_forward_refs()
