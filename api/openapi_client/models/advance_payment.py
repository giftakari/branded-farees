...
class AdvancePayment(BaseModel):
    ...
    __discriminator_value_class_map = {
        'AdvancePaymentIndeterminate': 'AdvancePaymentIndeterminate',
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Union(AdvancePaymentIndeterminate, AdvancePaymentRequired):
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Union(AdvancePaymentIndeterminate, AdvancePaymentRequired):
        ...
        if object_type:
            ...
            raise ValueError("AdvancePayment failed to lookup discriminator value from " +
...
AdvancePayment.update_forward_refs()
