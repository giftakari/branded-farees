...
class TravelerUpdatableItemGender(TravelerUpdatableItem):
    """
    TravelerUpdatableItemGender
    """
    gender_updatable: Optional[GenderEnum] = Field(None, alias="GenderUpdatable")
    __properties = ["@type", "Identifier", "addableInd", "modifiableInd", "deletableInd", "GenderUpdatable"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TravelerUpdatableItemGender:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TravelerUpdatableItemGender:
        """Create an instance of TravelerUpdatableItemGender from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TravelerUpdatableItemGender.parse_obj(obj)

        _obj = TravelerUpdatableItemGender.parse_obj({
            "type": obj.get("@type"),
