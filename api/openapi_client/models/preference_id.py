...
class PreferenceID(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Union(Preference, PreferenceAirSeat):
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Union(Preference, PreferenceAirSeat):
        ...
        if object_type:
            ...
            raise ValueError("PreferenceID failed to lookup discriminator value from " +
...
PreferenceID.update_forward_refs()
