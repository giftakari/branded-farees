...
class DocumentMCOExchange(Document):
    """
    DocumentMCOExchange
    """
    exchange_ind: Optional[StrictBool] = Field(None, alias="exchangeInd", description="If true, this MCO has been exchanged")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocumentMCOExchange:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocumentMCOExchange:
        """Create an instance of DocumentMCOExchange from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocumentMCOExchange.parse_obj(obj)

        _obj = DocumentMCOExchange.parse_obj({
            "type": obj.get("@type"),
