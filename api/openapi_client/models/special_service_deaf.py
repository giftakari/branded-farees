...
class SpecialServiceDeaf(SpecialService):
    """
    SpecialServiceDeaf
    """
    deaf_assistance_requested_ind: Optional[StrictBool] = Field(None, alias="deafAssistanceRequestedInd", description="If True the Traveler is Deaf and requests assistance")
    __properties = ["@type", "id", "Identifier", "AppliesTo", "Status", "ServiceAnimalType", "TravelerIdentifier", "deafAssistanceRequestedInd"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SpecialServiceDeaf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SpecialServiceDeaf:
        """Create an instance of SpecialServiceDeaf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SpecialServiceDeaf.parse_obj(obj)

        _obj = SpecialServiceDeaf.parse_obj({
            "type": obj.get("@type"),
            "id": obj.get("id"),
            ...
            "deaf_assistance_requested_ind": obj.get("deafAssistanceRequestedInd")
        })
        return _obj
