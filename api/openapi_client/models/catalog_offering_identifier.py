...
class CatalogOfferingIdentifier(BaseModel):
    """
    ...
    __properties = ["id", "CatalogOfferingRef", "Identifier"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CatalogOfferingIdentifier:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CatalogOfferingIdentifier:
        """Create an instance of CatalogOfferingIdentifier from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CatalogOfferingIdentifier.parse_obj(obj)

        _obj = CatalogOfferingIdentifier.parse_obj({
            "id": obj.get("id"),
