...
class ArrivalDetail(Arrival):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ArrivalDetail:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ArrivalDetail:
        """Create an instance of ArrivalDetail from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ArrivalDetail.parse_obj(obj)

        _obj = ArrivalDetail.parse_obj({
            "type": obj.get("@type"),
