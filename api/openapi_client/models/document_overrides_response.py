...
class DocumentOverridesResponse(BaseModel):
    """
    DocumentOverridesResponse
    """
    document_overrides: Optional[DocumentOverridesID] = Field(None, alias="DocumentOverrides")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocumentOverridesResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocumentOverridesResponse:
        """Create an instance of DocumentOverridesResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocumentOverridesResponse.parse_obj(obj)

        _obj = DocumentOverridesResponse.parse_obj({
