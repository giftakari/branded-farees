...
class ModifyPriceDetail(ModifyPrice):
    """
    ModifyPriceDetail
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ModifyPriceDetail:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ModifyPriceDetail:
        """Create an instance of ModifyPriceDetail from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ModifyPriceDetail.parse_obj(obj)

        _obj = ModifyPriceDetail.parse_obj({
            "type": obj.get("@type"),
            "id": obj.get("id"),
