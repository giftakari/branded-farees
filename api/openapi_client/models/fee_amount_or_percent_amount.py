...
class FeeAmountOrPercentAmount(FeeAmountOrPercent):
    """
    FeeAmountOrPercentAmount
    """
    amount: Optional[CurrencyAmount] = Field(None, alias="Amount")
    __properties = ["@type", "application", "Amount"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FeeAmountOrPercentAmount:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FeeAmountOrPercentAmount:
        """Create an instance of FeeAmountOrPercentAmount from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FeeAmountOrPercentAmount.parse_obj(obj)

        _obj = FeeAmountOrPercentAmount.parse_obj({
            "type": obj.get("@type"),
