...
class TravelerIdentifier(BaseModel):
    """
    TravelerIdentifier
    """
    ...
    __properties = ["id", "TravelerRef", "Identifier"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TravelerIdentifier:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TravelerIdentifier:
        """Create an instance of TravelerIdentifier from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TravelerIdentifier.parse_obj(obj)

        _obj = TravelerIdentifier.parse_obj({
            "id": obj.get("id"),
