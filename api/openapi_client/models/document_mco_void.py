...
class DocumentMCOVoid(Document):
    """
    DocumentMCOVoid
    """
    void_ind: Optional[StrictBool] = Field(None, alias="VoidInd", description="If true, the MCO has been voided")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocumentMCOVoid:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocumentMCOVoid:
        """Create an instance of DocumentMCOVoid from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocumentMCOVoid.parse_obj(obj)

        _obj = DocumentMCOVoid.parse_obj({
            "type": obj.get("@type"),
