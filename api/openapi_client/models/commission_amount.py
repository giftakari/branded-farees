...
class CommissionAmount(Commission):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CommissionAmount:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CommissionAmount:
        """Create an instance of CommissionAmount from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CommissionAmount.parse_obj(obj)

        _obj = CommissionAmount.parse_obj({
            "type": obj.get("@type"),
