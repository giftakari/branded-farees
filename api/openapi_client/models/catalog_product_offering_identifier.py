...
class CatalogProductOfferingIdentifier(BaseModel):
    """
    ...
    __properties = ["id", "Identifier", "CatalogProductOfferingRef"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CatalogProductOfferingIdentifier:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CatalogProductOfferingIdentifier:
        """Create an instance of CatalogProductOfferingIdentifier from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CatalogProductOfferingIdentifier.parse_obj(obj)

        _obj = CatalogProductOfferingIdentifier.parse_obj({
            "id": obj.get("id"),
