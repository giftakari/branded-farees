...
class DocumentForfeit(Document):
    """
    DocumentForfeit
    """
    forfeit_ind: Optional[StrictBool] = Field(None, alias="forfeitInd", description="If true the value of the document has been forfeited")
    __properties = ["@type", "Number", "TravelerIdentifierRef", "Amount", "WaiverCode", "Commission", "CumulativeValue", "IssuingPCC", "IssuingIATA", "IssuingCity", "FiledAmount", "forfeitInd"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocumentForfeit:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocumentForfeit:
        """Create an instance of DocumentForfeit from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocumentForfeit.parse_obj(obj)

        _obj = DocumentForfeit.parse_obj({
            "type": obj.get("@type"),
