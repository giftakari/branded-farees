...
class TravelerUpdatedItemEmail(TravelerUpdatedItem):
    """
    TravelerUpdatedItemEmail
    """
    email: Email = Field(..., alias="Email")
    __properties = ["@type", "TravelerUpdatableItemID", "addInd", "modifyInd", "deleteInd", "Email"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TravelerUpdatedItemEmail:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TravelerUpdatedItemEmail:
        """Create an instance of TravelerUpdatedItemEmail from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TravelerUpdatedItemEmail.parse_obj(obj)

        _obj = TravelerUpdatedItemEmail.parse_obj({
            "type": obj.get("@type"),
