...
class AppliesToOfferProduct(AppliesTo):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AppliesToOfferProduct:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AppliesToOfferProduct:
        """Create an instance of AppliesToOfferProduct from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AppliesToOfferProduct.parse_obj(obj)

        _obj = AppliesToOfferProduct.parse_obj({
            "type": obj.get("@type"),
