...
class CatalogProductOfferingsResponse(BaseModel):
    """
    CatalogProductOfferingsResponse
    """
    catalog_product_offerings: CatalogProductOfferings = Field(..., alias="CatalogProductOfferings")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CatalogProductOfferingsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CatalogProductOfferingsResponse:
        """Create an instance of CatalogProductOfferingsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CatalogProductOfferingsResponse.parse_obj(obj)

        _obj = CatalogProductOfferingsResponse.parse_obj({
