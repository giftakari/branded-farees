...
class ProductID(BaseModel):
    ...
    __properties = ["@type", "id", "productRef", "Identifier"]
    ...
    __discriminator_value_class_map = {
        ...
        'ProductAncillary': 'ProductAncillary',
        'ProductAncillaryVehicle': 'ProductAncillaryVehicle',
        'ProductHospitality': 'ProductHospitality',
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Union(Product, ProductAir, ProductAncillary, ProductAncillaryVehicle, ProductHospitality, ProductVehicle):
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Union(Product, ProductAir, ProductAncillary, ProductAncillaryVehicle, ProductHospitality, ProductVehicle):
        ...
        if object_type:
            ...
            raise ValueError("ProductID failed to lookup discriminator value from " +
