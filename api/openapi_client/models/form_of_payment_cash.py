...
class FormOfPaymentCash(FormOfPaymentID):
    """
    FormOfPaymentCash
    """
    agent_non_refundable_ind: Optional[StrictBool] = Field(None, alias="agentNonRefundableInd", description="This indicates that the Cash payment should not be refunded")
    __properties = ["@type", "id", "FormOfPaymentRef", "Identifier", "agentNonRefundableInd"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FormOfPaymentCash:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FormOfPaymentCash:
        """Create an instance of FormOfPaymentCash from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FormOfPaymentCash.parse_obj(obj)

        _obj = FormOfPaymentCash.parse_obj({
            "type": obj.get("@type"),
            "id": obj.get("id"),
            ...
            "agent_non_refundable_ind": obj.get("agentNonRefundableInd")
        })
        return _obj
