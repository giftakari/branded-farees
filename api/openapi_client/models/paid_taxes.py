...
class PaidTaxes(BaseModel):
    ...
    __discriminator_value_class_map = {
        'PaidTaxesDetail': 'PaidTaxesDetail'
    }
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Union(PaidTaxesDetail):
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Union(PaidTaxesDetail):
        ...
        if object_type:
            ...
            raise ValueError("PaidTaxes failed to lookup discriminator value from " +
                             json.dumps(obj) + ". Discriminator property name: " + cls.__discriminator_property_name +
                             ", mapping: " + json.dumps(cls.__discriminator_value_class_map))

from openapi_client.models.paid_taxes_detail import PaidTaxesDetail
PaidTaxes.update_forward_refs()
