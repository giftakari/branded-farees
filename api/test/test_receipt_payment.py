...
from openapi_client.models.receipt_payment import ReceiptPayment  # noqa: E501
from openapi_client.rest import ApiException

class TestReceiptPayment(unittest.TestCase):
    """ReceiptPayment unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `ReceiptPayment`
        """
        model = openapi_client.models.receipt_payment.ReceiptPayment()  # noqa: E501
        if include_optional :
            return ReceiptPayment(
                payment_identifier = openapi_client.models.payment_identifier.PaymentIdentifier(
                    @type = 'Payment', 
                    id = '', 
                    payment_ref = '', 
