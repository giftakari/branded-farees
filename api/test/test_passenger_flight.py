...
from openapi_client.models.passenger_flight import PassengerFlight  # noqa: E501
from openapi_client.rest import ApiException

class TestPassengerFlight(unittest.TestCase):
    """PassengerFlight unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test PassengerFlight
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PassengerFlight`
        """
        model = openapi_client.models.passenger_flight.PassengerFlight()  # noqa: E501
        if include_optional :
