...
from openapi_client.models.organization_loyalty_program_list_response import OrganizationLoyaltyProgramListResponse  # noqa: E501
from openapi_client.rest import ApiException

class TestOrganizationLoyaltyProgramListResponse(unittest.TestCase):
    """OrganizationLoyaltyProgramListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test OrganizationLoyaltyProgramListResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrganizationLoyaltyProgramListResponse`
        """
        model = openapi_client.models.organization_loyalty_program_list_response.OrganizationLoyaltyProgramListResponse()  # noqa: E501
        if include_optional :
            return OrganizationLoyaltyProgramListResponse(
                organization_loyalty_program = [
                    openapi_client.models.organization_loyalty_program_id.OrganizationLoyaltyProgramID(
    ...
    def testOrganizationLoyaltyProgramListResponse(self):
        """Test OrganizationLoyaltyProgramListResponse"""
