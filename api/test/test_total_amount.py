...
from openapi_client.models.total_amount import TotalAmount  # noqa: E501
from openapi_client.rest import ApiException

class TestTotalAmount(unittest.TestCase):
    """TotalAmount unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `TotalAmount`
        """
        model = openapi_client.models.total_amount.TotalAmount()  # noqa: E501
        if include_optional :
            return TotalAmount(
                type = 'Amount', 
