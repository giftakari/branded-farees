...
from openapi_client.models.vehicle_price import VehiclePrice  # noqa: E501
from openapi_client.rest import ApiException

class TestVehiclePrice(unittest.TestCase):
    """VehiclePrice unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `VehiclePrice`
        """
        model = openapi_client.models.vehicle_price.VehiclePrice()  # noqa: E501
        if include_optional :
            return VehiclePrice(
                type = 'VehiclePrice', 
                id = '', 
