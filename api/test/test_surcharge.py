...
from openapi_client.models.surcharge import Surcharge  # noqa: E501
...
class TestSurcharge(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `Surcharge`
        """
        model = openapi_client.models.surcharge.Surcharge()  # noqa: E501
        if include_optional :
            return Surcharge(
                value = 12, 
                currency_code = 'USD', 
