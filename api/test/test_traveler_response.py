...
from openapi_client.models.traveler_response import TravelerResponse  # noqa: E501
from openapi_client.rest import ApiException

class TestTravelerResponse(unittest.TestCase):
    """TravelerResponse unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test TravelerResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TravelerResponse`
        """
        model = openapi_client.models.traveler_response.TravelerResponse()  # noqa: E501
        if include_optional :
