...
from openapi_client.models.vehicle_travel_criteria import VehicleTravelCriteria  # noqa: E501
from openapi_client.rest import ApiException

class TestVehicleTravelCriteria(unittest.TestCase):
    """VehicleTravelCriteria unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test VehicleTravelCriteria
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VehicleTravelCriteria`
        """
        model = openapi_client.models.vehicle_travel_criteria.VehicleTravelCriteria()  # noqa: E501
        if include_optional :
            return VehicleTravelCriteria(
                ...
                vehicle_date_location = openapi_client.models.vehicle_date_location.VehicleDateLocation(
                    ...
                    rental_return = openapi_client.models.rental_pickup_return.RentalPickupReturn(
                        ...
                        date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                        time = 'HH.MM.SS', ), ), 
                booking_source = openapi_client.models.code.Code(
                    value = 'INS', 
                    code_context = 'infant with a seat', ), 
    ...
    def testVehicleTravelCriteria(self):
        """Test VehicleTravelCriteria"""
