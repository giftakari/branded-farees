...
from openapi_client.models.build_ancillary_offers_from_catalog_offerings import BuildAncillaryOffersFromCatalogOfferings  # noqa: E501
from openapi_client.rest import ApiException

class TestBuildAncillaryOffersFromCatalogOfferings(unittest.TestCase):
    """BuildAncillaryOffersFromCatalogOfferings unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test BuildAncillaryOffersFromCatalogOfferings
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BuildAncillaryOffersFromCatalogOfferings`
        """
        model = openapi_client.models.build_ancillary_offers_from_catalog_offerings.BuildAncillaryOffersFromCatalogOfferings()  # noqa: E501
        if include_optional :
            return BuildAncillaryOffersFromCatalogOfferings(
    ...
    def testBuildAncillaryOffersFromCatalogOfferings(self):
        """Test BuildAncillaryOffersFromCatalogOfferings"""
