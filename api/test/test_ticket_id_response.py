...
from openapi_client.models.ticket_id_response import TicketIdResponse  # noqa: E501
from openapi_client.rest import ApiException

class TestTicketIdResponse(unittest.TestCase):
    """TicketIdResponse unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test TicketIdResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TicketIdResponse`
        """
        model = openapi_client.models.ticket_id_response.TicketIdResponse()  # noqa: E501
        if include_optional :
