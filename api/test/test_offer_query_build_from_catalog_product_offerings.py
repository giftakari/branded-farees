...
from openapi_client.models.offer_query_build_from_catalog_product_offerings import OfferQueryBuildFromCatalogProductOfferings  # noqa: E501
from openapi_client.rest import ApiException

class TestOfferQueryBuildFromCatalogProductOfferings(unittest.TestCase):
    """OfferQueryBuildFromCatalogProductOfferings unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test OfferQueryBuildFromCatalogProductOfferings
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OfferQueryBuildFromCatalogProductOfferings`
        """
        model = openapi_client.models.offer_query_build_from_catalog_product_offerings.OfferQueryBuildFromCatalogProductOfferings()  # noqa: E501
        if include_optional :
            return OfferQueryBuildFromCatalogProductOfferings(
    ...
    def testOfferQueryBuildFromCatalogProductOfferings(self):
        """Test OfferQueryBuildFromCatalogProductOfferings"""
